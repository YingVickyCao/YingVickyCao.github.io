...
Tumblr,StackOverflow,简书很多交流网站也在使用Markdown格式编译。
...
Markdown需要插入换行符时，可在一行的结尾加上两个或更多的空格。

# 段落
在MarkDown里面，没有任何修饰的文本就是段落，
...
markdown会把多余空行省略，是它的成功之处，文章结构不是靠空行区分的。
...
- [Markdown软件和在线编译器推荐](http://www.williamlong.info/archives/4319.html)
- [模拟Makdown语法](http://daringfireball.net/projects/markdown/dingus)
