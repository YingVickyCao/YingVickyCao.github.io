# TextSwitcher
## 用途
- 使用TextSwitcher和ImageSwitcher分别代替Textview 和ImageView，切换内容时，增加动态效果，使得内容过度更自然  
使用动画切换 `TextView`
- 不要滥用TextSwitcher和ImageSwitchery 
...
- TextSwitcher机制与ImageSwitcher类似。

## Textview VS TextSwitcher
- Textview的内容切换是立刻改变。
- 使用TextSwitcher和ImageSwitcher切换内容时带动态效果
